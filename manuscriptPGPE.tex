...
\begin{figure*}[]
  \centering
   ...
   \caption{\label{HGorderParameters}
    ...
    \textbf{D)} Headgroup and glycerol backbone C--H bond order parameters $S_mathrm{CH}$ for different phospholipids measured in the lamellar liquid disordered phase.
