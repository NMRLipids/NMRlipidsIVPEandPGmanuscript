...
% insert abstract here
  ...
  Because conformational ensembles of lipid headgroups in physiologically relevant liquid state 
  ...
  Our results propose that lipids are able to select a suitable headgroup conformation
...
but their relation to lipids in bulk membranes in the liquid lamellar phase remains unclear \cite{marsh13b}. Similarly to disordered proteins~\cite{sormanni17}, lipid molecules sample conformational ensembles which are composed of sets of individual structures whose probabilities of occurrences are determined by the Boltzmann distribution. In liquid bilayer state, individual phosphatidylcholine lipid samples the conformational ensemble within nanosecond timescale~\cite{ferreira15}. The most accurate experimental information on conformational ensembles of lipids
in this biologically relevant phase are typically derived from NMR experiments, particularly from the
C--H bond order parameters, $S_\mathrm{CH}=\frac{3}{2} \langle \cos^2 \theta -1 \rangle$, where $\theta$ is the angle between C-H bond and membrane normal, and the average is taken over the conformational ensemble of lipids~\cite{seelig77c,davis83,Semchyschyn04}.
...
\begin{figure*}
  \centering
   ...
   \caption{\label{structures}
     ...
     \textbf{B)} Headgroup and glycerol backbone region order parameters of different lipids. Colored shaded regions show the range of experimental values for POPC from Fig. \ref{HGorderParameters}.
