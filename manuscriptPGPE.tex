...
% insert abstract here
  The chemistry of lipid headgroups, the water facing components of cell membranes that regulate cell functions via lipid--protein interactions, varies between organisms and organelles. In physiologically relevant liquid state,
  lipid molecules are not fixed to a single structure but they sample an ensemble of conformations with the Boltzmann weighted probabilities.
  However, the distributions of conformations in these ensembles and their dependence on lipid types have not yet been experimentally determined. 
  ...
  Together with the analysis of 894 protein-bound lipid structures from the protein data bank (PDB), this suggests that lipids can bind to proteins in wide range of conformations which are not limited by the headgroup chemistry. Therefore, the selective adsorption of peripheral proteins to membranes and binding of lipids to transmembrane proteins are likely regulated by specific protein--lipid interactions rather than conformational restrictions of the lipids.
