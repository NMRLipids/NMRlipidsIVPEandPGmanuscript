...
% insert abstract here
  ...
  have not yet been experimentally determined, a crucial piece has been missing from the conception on how they interact with other biomolecules: 
  ...
  Here, we combine solid-state NMR experiments and molecular dynamics simulations from the NMRlipids Project to resolve the conformational ensembles of headgroups of four key lipid types in various biologically relevant conditions. We find that all lipid headgroup types sample a wide range of conformations % a wide range of conformations
  ...
  Together with the analysis of 894 protein-bound lipid structures from the Protein Data Bank (PDB), this suggests that lipids can bind to proteins in a wide range of conformations, which are not limited by the headgroup chemistry.
  ...
  Our results propose that lipids are able to select a suitable conformation from the wide range of selection to fit the various binding sites in proteins.
  The proposed {\it inverse conformational selection model} can be also extended to lipid binding to other biomolecules than proteins, such as drug, RNA and viruses.
...
the design of phoshopolipid-specific antibodies and lipid nanoparticle carries with minimal sides effects for mRNA vaccines.
